 ...
 * Animated loading component for authentication redirect
 */
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-center mb-4">
        <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center auth-success-icon">
      ...
      <div className="flex flex-col items-center space-y-3">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground">Redirection vers le dashboard...</p>
        </div>
      </div>
    </div>
  )
